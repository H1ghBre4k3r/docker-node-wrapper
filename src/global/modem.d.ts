...
// Modified by: Louis Meyer<https://github.com/h1ghbre4k3r
...
declare module "docker-modem" {
    class Modem implements Modem.SocketOptions, Modem.HostOptions {
         ...
         */
        public followProgress<T>(
            stream: NodeJS.ReadableStream,
            onFinished: Modem.Callback<T>,
        ...
        private buildRequest<T>(
            options: any,
            context: Modem.DialOptions,
            data: string | Buffer,
            callback: Modem.Callback<T>
        ): void;
